...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKLOCATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKLOCATION actions', async () => {
      const expectedActions = [
        {
