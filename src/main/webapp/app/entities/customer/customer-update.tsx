  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="workhourshipsterApp.customer.home.createOrEditLabel" data-cy="CustomerCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Adress" id="customer-adress" name="adress" data-cy="adress" type="text" />
