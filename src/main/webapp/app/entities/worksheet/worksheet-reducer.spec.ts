...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './worksheet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKSHEET_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKSHEET actions', async () => {
      const expectedActions = [
        {
