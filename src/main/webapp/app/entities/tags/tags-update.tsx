...
export const TagsUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const saveEntity = values => {
    const entity = {
      ...tagsEntity,
      ...values,
      entries: mapIdList(values.entries),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...tagsEntity,
          entries: tagsEntity?.entries?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="workhourshipsterApp.tags.home.createOrEditLabel" data-cy="TagsCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Entry" id="tags-entry" data-cy="entry" type="select" multiple name="entries">
                <option value="" key="0" />
                {entries
                  ? entries.map(otherEntity => (
