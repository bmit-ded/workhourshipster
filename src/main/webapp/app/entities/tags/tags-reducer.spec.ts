...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tags.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAGS actions', async () => {
      const expectedActions = [
        {
