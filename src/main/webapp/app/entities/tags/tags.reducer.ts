...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ITags, thunkAPI) => {
    const result = await axios.post<ITags>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  'tags/update_entity',
  async (entity: ITags, thunkAPI) => {
    const result = await axios.put<ITags>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ITags, thunkAPI) => {
    const result = await axios.patch<ITags>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<ITags>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
