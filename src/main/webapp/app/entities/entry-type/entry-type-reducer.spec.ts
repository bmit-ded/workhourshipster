...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTRYTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENTRYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENTRYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENTRYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENTRYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENTRYTYPE actions', async () => {
      const expectedActions = [
        {
