...
public interface ProjectRepository extends JpaRepository<Project, Long> {
    ...
    @Query(
        value = "select distinct project from Project project left join fetch project.customer",
    ...
    @Query("select distinct project from Project project left join fetch project.customer")
    List<Project> findAllWithToOneRelationships();

    @Query("select project from Project project left join fetch project.customer where project.id =:id")
