...
/**
 * REST controller for managing {@link com.contexity.whh.domain.Project}.
 */
@RestController
@RequestMapping("/api")
public class ProjectResource {
     ...
     */
    @GetMapping("/projects")
    public List<ProjectDTO> getAllProjects(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
