...
import com.contexity.whh.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).adress(DEFAULT_ADRESS).phone(DEFAULT_PHONE).email(DEFAULT_EMAIL);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).adress(UPDATED_ADRESS).phone(UPDATED_PHONE).email(UPDATED_EMAIL);
        return customer;
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).adress(UPDATED_ADRESS).phone(UPDATED_PHONE).email(UPDATED_EMAIL);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).adress(UPDATED_ADRESS).phone(UPDATED_PHONE).email(UPDATED_EMAIL);
